...
import (
	...
	basetypes "github.com/forbole/bdjuno/v3/chains/base/types"

	dbtypes "github.com/forbole/bdjuno/v3/chains/custom/database/types"
	dbutils "github.com/forbole/bdjuno/v3/chains/custom/database/utils"
...
func (db *Db) saveProviders(paramsNumber int, providers []*types.Provider, height int64) error {
	...
	accounts := make([]basetypes.Account, len(providers))
	for i, provider := range providers {
		...
		accounts[i] = basetypes.NewAccount(provider.OwnerAddress)
	}
