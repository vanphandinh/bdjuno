...
require (
	github.com/forbole/bdjuno/v3/chains/base v0.0.0
	github.com/forbole/bdjuno/v3/chains/custom v0.0.0
...
require (
	...
	github.com/cosmos/gaia/v7 v7.0.2 // indirect
)
...
require (
	...
	github.com/gtank/ristretto255 v0.1.2 // indirect; indirectf
...
replace (
	// Local modules
	github.com/forbole/bdjuno/v3/chains/base => ./chains/base
	github.com/forbole/bdjuno/v3/chains/custom => ./chains/cosmoshub
